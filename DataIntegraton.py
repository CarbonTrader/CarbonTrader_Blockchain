...
class DataIntegrator:
    ...
    def reset_all():
        ...
        DataIntegrator.write_json("local_transactions.json", [])
    ...
    def update_transactions_to_mine():
        ...
        DataIntegrator.write_json("local_transactions.json", transactions[3:])
        DataIntegrator.write_json("transactions_to_mine.json", transactions[:3])